...
psi_mu2 = q2.*normpdf(w2 + q2.*mu2)./Phi.* ...
    normcdf((w3 + q3.*mu3 - gmms.*(w2 + q2.*mu2)).*delta);
psi_mu3 = q3.*normpdf(w3 + q3.*mu3)./Phi.* ...
    normcdf((w2 + q2.*mu2 - gmms.*(w3 + q3.*mu3)).*delta);
...
psi_mu2_mu2 = -normpdf(w2 + q2.*mu2)./Phi.*(...
    (w2 + q2.*mu2).*normcdf((w3 + q3.*mu3 - gmms.*(w2 + q2.*mu2)).*delta) ...
    + normpdf((w3 + q3.*mu3 - gmms.*(w2 + q2.*mu2)).*delta).* ...
    gmms.*delta);
    
psi_mu3_mu3 = -normpdf(w3 + q3.*mu3)./Phi.*(...
    (w3 + q3.*mu3).*normcdf((w2 + q2.*mu2 - gmms.*(w3 + q3.*mu3)).*delta) ...
    + normpdf((w2 + q2.*mu2 - gmms.*(w3 + q3.*mu3)).*delta).* ...
    gmms.*delta);
    
psi_mu2_mu3 = q2.*q3./Phi.*normpdf(w2 + q2.*mu2).*delta ...
    .*normpdf((w3 + q3.*mu3 - gmms.*(w2 + q2.*mu2)).*delta);
